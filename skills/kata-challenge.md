...
2. เลือก 3 concepts — สร้าง challenge หนึ่งข้อต่อ concept
3. สำหรับแต่ละ concept — สร้าง snippet ใหม่ที่:
   - ใช้ use case ต่างออกไป (เช่น `ReadConfig` → `ReadCertificate`, `LoadTemplate`, `ReadKey`)
   - มี bug จาก concept นั้น แต่ subtle พอที่จะต้องอ่านทั้งฟังก์ชัน
